...
- **close**: verb only, to move to a position that stops flow, or to operate a circuit breaker. The adjective is unapproved, so use **near** ("do not go near the propeller").
- **test**: noun only. "Do a test," never "test the system."
- **check**: do not use as a verb for verification. Use "make sure that" or "examine."
...
- **oil**: noun only. "Oil the bearing" becomes "Put oil on the bearing" or "Lubricate the bearing."
- **right**: direction only, never "correct."
- **clear**: "without blockage." "Wheels are clear of the ground" becomes "wheels do not touch the ground."
- **help**: verb only. The noun is **aid** ("with the aid of a mirror").
- **above / below**: physical position only. For quantities use **more than / less than**.
...
- **level**: approved as noun and adjective (documented exception to the one-part-of-speech rule).

## Frequent-offender function words

- **should / would / could / may / might**: never. Requirement becomes **must**. Possibility becomes **can**. Future becomes **will**.
...
- **there is / there are** openers: rewrite with a real subject. "There are three bolts on the panel" becomes "The panel has three bolts."
