---
name: ste
description: "Write or rewrite prose in ASD-STE100 Simplified Technical English."
disable-model-invocation: true
argument-hint: "Text to rewrite, or nothing to apply it to the rest of this task"
---
...
- Never use present perfect or continuous forms. "We have received" becomes "We received." "is being tested" becomes a simple form.
...
- No phrasal verbs: "go down" becomes "decrease," "set up" becomes "install," "carry out" becomes "do."
...
- No Latin abbreviations: "e.g." becomes "for example," "i.e." becomes "that is," delete "etc."
...
- **WARNING** means risk of injury or death. **CAUTION** means risk of damage. **NOTE** is information only, never an instruction.
...
- `references/word-substitutions.md`: unapproved to approved word mappings and one-meaning rulings. Read it before drafting; it is short.
