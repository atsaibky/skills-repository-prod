...
- **[ste](./skills/productivity/ste/SKILL.md)**: Write or rewrite prose in ASD-STE100 Simplified Technical English, the controlled-English standard from aerospace maintenance manuals: capped sentence length and one approved word per meaning.
...
- **[writing-for-humans](./skills/productivity/writing-for-humans/SKILL.md)**: Strip the tells that mark prose as AI-generated: the "that's not X, that's Y" flip, the self-congratulating aside, the warm-up phrase, the rule of three. The human-facing counterpart to `writing-for-agents`.
